...
public class DeliveryBoy {
	...
	@Pattern(regexp="([987][0-9]{9})",message = "Should start with 9,8,7 and must have 10 digits")
	...
	@Pattern(regexp = "([A-Za-z0-9]+@{1}[A-Za-z]+\\.{1}com)",message = "Email should start with alphanumeric characters contain one @, one (.) and (com) in last")
	 ...
	 */
	public DeliveryBoy(@NotBlank(message = "Delivery boy identifier can't be blank") @Size(min = 4, max = 5, message = "Size must be between 4 to 5 characters") String deliveryBoyIdentifier,
